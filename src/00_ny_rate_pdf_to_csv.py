...
df = tabula.read_pdf('pub718.pdf', multiple_tables=True, pages='all'
                     )
...
county_rates.to_csv("ny_county_rates.csv", index=False)
...
city_rates.to_csv("ny_city_rates.csv", index=False)
